...
public interface FeedbackService {
    ...
    FeedbackDetailResponse generate(Long userId, FeedbackGenerateRequest request);

    RetryWordResult retryWord(Long userId, Long feedbackId, MultipartFile audio);

    List<FeedbackSummaryResponse> listMine(Long userId);

    FeedbackDetailResponse get(Long userId, Long feedbackId);
