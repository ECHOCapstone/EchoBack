...
public enum ErrorCode {
    ...
    PHONEME_ASSET_NOT_FOUND(HttpStatus.NOT_FOUND, "음소 이미지를 찾을 수 없습니다."),
    ...
    // LLM canonical 생성 실패. silent fallback 을 의도적으로 차단해 사용자가 "the" 같은 문맥 의존
    // 발음을 잘못된 정답과 비교하는 채점 오인지를 막는다.
